...
const workList = [
  ...
  },
  {
    ...
    location: 'Perth, WA',
    description: [
      'Delivered Dash and Plotly prototypes aligned with product requirements, stakeholder workflows, and visual design expectations',
      'Integrated the latest prototype with an Azure SQL endpoint to support live data access and reporting use cases',
      'Designed a caching layer to improve responsiveness for heavy data-loading scenarios',
  ...
  },
  {
    ...
    description: [
      ...
      "Researched 2D and 3D tooling options and documented technical findings in the team's Jira and Confluence knowledge base",
